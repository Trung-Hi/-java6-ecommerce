import {computed, onMounted, reactive, ref} from "https://unpkg.com/vue@3/dist/vue.esm-browser.js";
import {api} from "/vue/api.js";
...
const AdminProductPage = {
    setup() {
        const state = reactive({rows: [], categories: [], page: 0, totalPages: 0, keyword: "", categoryId: ""});
        const form = reactive({id: "", name: "", price: "", discount: "", quantity: "", available: true, categoryId: "", description: ""});
        const editing = ref(false);
        const message = ref("");
        const load = async () => {
            const res = await api.admin.products.list({page: state.page, keyword: state.keyword, categoryId: state.categoryId});
            const data = res.data || {};
...
export const routes = [
    {path: "/auth/login", component: LoginPage, meta: {title: "auth/login", template: "auth/login.html"}},
    {path: "/home/index", component: HomePage, meta: {title: "home/index", template: "home/index.html"}},
    {path: "/product/list", component: ProductListPage, meta: {title: "product/list", template: "product/list.html"}},
    {path: "/product/detail", component: ProductDetailPage, meta: {title: "product/detail", template: "product/detail.html"}},
    {path: "/cart/index", component: CartPage, meta: {title: "cart/index", template: "cart/index.html"}},
    {path: "/order/check-out", component: CheckoutPage, meta: {title: "order/check-out", template: "order/check-out.html"}},
    {path: "/order/bank-transfer", component: BankTransferPage, meta: {title: "order/bank-transfer", template: "order/bank-transfer.html"}},
    {path: "/order/order-list", component: OrderListPage, meta: {title: "order/order-list", template: "order/order-list.html"}},
    {path: "/order/order-detail", component: OrderDetailPage, meta: {title: "order/order-detail", template: "order/order-detail.html"}},
    {path: "/order/my-product-list", component: MyProductListPage, meta: {title: "order/my-product-list", template: "order/my-product-list.html"}},
    {path: "/account/sign-up", component: SignUpPage, meta: {title: "account/sign-up", template: "account/sign-up.html"}},
    {path: "/account/edit-profile", component: EditProfilePage, meta: {title: "account/edit-profile", template: "account/edit-profile.html"}},
    {path: "/account/change-password", component: ChangePasswordPage, meta: {title: "account/change-password", template: "account/change-password.html"}},
    {path: "/account/forgot-password", component: ForgotPasswordPage, meta: {title: "account/forgot-password", template: "account/forgot-password.html"}},
    {path: "/admin/account", component: AdminAccountPage, meta: {title: "admin/account", template: "admin/account.html"}},
    {path: "/admin/category", component: AdminCategoryPage, meta: {title: "admin/category", template: "admin/category.html"}},
    {path: "/admin/product", component: AdminProductPage, meta: {title: "admin/product", template: "admin/product.html"}},
    {path: "/admin/order", component: AdminOrderPage, meta: {title: "admin/order", template: "admin/order.html"}},
    {path: "/admin/revenue", component: AdminRevenuePage, meta: {title: "admin/revenue", template: "admin/revenue.html"}},
    {path: "/admin/vip", component: AdminVipPage, meta: {title: "admin/vip", template: "admin/vip.html"}},
    {path: "/admin/camera", component: AdminCameraPage, meta: {title: "admin/camera", template: "admin/camera.html"}},
    {path: "/:pathMatch(.*)*", redirect: "/home/index"}
];

export const templateCoverage = routes.filter(r => r.meta?.template).map(r => r.meta.template);
