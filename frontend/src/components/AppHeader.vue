        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <router-link class="navbar-brand" to="/home/index">
                    <span class="brand-text">Lamb</span>
                </router-link>
                ...
                <div class="collapse navbar-collapse" id="mainNav">
                    ...
                    <div class="header-actions" v-if="!isAuthenticated">
                        <router-link class="btn btn-outline-dark btn-sm" to="/auth/login">Đăng nhập</router-link>
                        <router-link class="btn btn-dark btn-sm" to="/account/sign-up">Đăng ký</router-link>
                    </div>
