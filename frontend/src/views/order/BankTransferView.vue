            ...
            <div class="transfer-sheet-body">
                ...
                <div class="transfer-info-panel">
                    ...
                    <div class="transfer-info-row">
                        ...
                        <div class="transfer-info-value transfer-copy-line">
                            <span>{{ money(data.totalPrice) }} <small>đ</small></span>
                    ...
                    <div class="transfer-note">
                        Lưu ý: chuyển đúng số tiền <strong>{{ money(data.totalPrice) }} <small>đ</small></strong> và nội dung <strong>{{ transferContent() }}</strong>.
                    </div>
                </div>
            </div>
