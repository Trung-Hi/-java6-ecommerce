                        ...
                        <div class="product-card" v-for="p in data.filteredProducts" :key="'f'+p.id">
                            ...
                            <div class="product-card__info">
                                ...
                                <div class="product-card__price-row">
                                    <div class="product-card__price">{{ money(finalPrice(p)) }} <small style="font-size: 0.85rem; color: #888;">đ</small></div>
                                    <div v-if="hasDiscount(p)" class="product-card__price-old">{{ money(p.price) }} <small style="font-size: 0.8rem; color: #aaa;">đ</small></div>
