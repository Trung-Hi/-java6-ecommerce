                    ...
                    <table class="cart-table">
                        ...
                        <tbody>
                            <tr v-for="item in state.items" :key="item.productId + '-' + item.sizeId">
                                ...
                                <td>{{ money(item.price) }} <small>đ</small></td>
                                <td>{{ money(lineDiscount(item)) }} <small>đ</small></td>
                                <td>
                ...
                <div class="cart-summary">
                    <div class="cart-summary-content">
                        <div class="cart-summary-row">
                            <span>Tổng:</span>
                            <strong>{{ money(totalBeforeDiscount) }} <small>đ</small></strong>
                        </div>
                        <div class="cart-summary-row">
                            <span>Giảm giá:</span>
                            <strong>{{ money(totalDiscount) }} <small>đ</small></strong>
                        </div>
                        <div class="cart-summary-row">
                            <span>Số tiền cần thanh toán:</span>
                            <strong>{{ money(payableTotal) }} <small>đ</small></strong>
                        </div>
                    </div>
