            ...
            <section class="product-detail-content" v-if="data && data.product">
                ...
                <div class="detail-info-wrap">
                    ...
                    <div class="price-row">
                        ...
                        <span class="price-currency"><small>đ</small></span>
                        <span class="price-old" style="text-decoration: line-through; color: #999; margin-left: 12px; font-size: 1.2rem;" v-if="data.product.discount > 0">{{ money(data.product.price) }} <small style="font-size: 0.9rem; color: #aaa;">đ</small></span>
